package io.zabrek.soulbound.lib.dependency.component;
...
import io.zabrek.soulbound.lib.dependency.DefaultLoadedDependency;
import io.zabrek.soulbound.lib.dependency.DependencyHelper;
...
public class DefaultCoreComponentLoader implements CoreComponentLoader {
     ...
     */
    public DefaultCoreComponentLoader(final SoulBoundLogger log) {
        this.log = log;
    ...
    @Override
    public void load() {
        log.info("Loading %s SoulBound components...".formatted(components.size()));
